...
let
  ...
  zinitInit = optionalString zinitConfig.enable ''
    declare -A ZINIT
    ZINIT_HOME=${zinitConfig.zinitHome}
    ...
    programs.zsh = {
      ...
      zinit = {
        ...
        plugins = {
          ...
          "lucid depth=1 atload'zicompinit' light-mode" = [ "Aloxaf/fzf-tab" ];
          "wait'!1a' lucid blockf depth=1 light-mode" = [ "zdharma-continuum/fast-syntax-highlighting" ];
        };
      };
